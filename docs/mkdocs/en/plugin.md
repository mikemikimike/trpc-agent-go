...
For a runnable example using a real OpenAI-compatible model and `LLMAgent`, see
[examples/telemetry/global-after-run](https://github.com/trpc-group/trpc-agent-go/tree/main/examples/telemetry/global-after-run).
